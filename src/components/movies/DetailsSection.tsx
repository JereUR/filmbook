		...
		<>
			<div className="flex flex-col gap-2 space-y-2 p-2 md:mx-5 md:space-y-3">
				...
				<div className="ml-3 flex flex-col gap-2 rounded-2xl border border-primary/40 p-2 md:ml-5 md:gap-4 md:p-5">
					<h3 className="mb-1 text-sm font-semibold text-foreground/40 md:mb-0 md:text-base">
						Idiomas
					</h3>
					<ul className="ml-5 flex list-inside list-disc flex-wrap items-center gap-2 md:ml-8 md:gap-4">
						{spokenLanguages.map((language: Language) => (
							<li
								key={language.iso_639_1}
								className="mr-2 text-xs italic md:mr-4 md:text-sm"
							>
					...
					<ul className="ml-5 flex list-inside list-disc flex-wrap items-center gap-2 md:ml-8 md:gap-4">
						{productionCountries.map((country: Countries) => (
							<li
								...
								className="mr-2 flex items-center gap-2 text-xs italic md:mr-4 md:text-sm"
							>
								<Image
				...
				<div className="ml-3 flex flex-col gap-2 rounded-2xl border border-primary/40 p-2 md:ml-5 md:gap-4 md:p-5">
					...
					<ul className="ml-5 flex list-inside list-disc flex-wrap items-center gap-2 md:ml-8 md:gap-4">
						{productionCompanies.map((company: Companies) => (
							<li
								key={company.id}
								className="mr-2 flex flex-col items-center justify-center gap-1 text-xs italic md:mr-4 md:text-sm"
							>
								<Image
