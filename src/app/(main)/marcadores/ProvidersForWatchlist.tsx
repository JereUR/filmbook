...
export default function ProvidersForWatchlist({
	providersList,
	onClose
}: ProvidersForWatchlistProps) {
	...
	return (
		<div className="relative p-2">
			<div className="absolute -right-2 -top-2">
				<span
					className="flex cursor-pointer items-center gap-3 font-bold text-destructive"
					onClick={onClose}
				>
					<X className="size-5 text-destructive" />
				</span>
			</div>
			<div className="mb-2 flex flex-col items-start gap-4 md:mb-4 md:flex-row md:items-center md:justify-between">
