			...
			<div className="w-full min-w-0 space-y-5">
				...
				<Tabs defaultValue="posts" className="w-full">
					<TabsList className="rounded-md bg-card-child p-1 text-muted-foreground shadow-sm">
						...
						<TabsTrigger value="diary" className="text-xs sm:text-sm">
							Bitácora
						</TabsTrigger>
					</TabsList>
		...
		<div className="h-fit w-full space-y-5 rounded-2xl bg-card p-5 shadow-sm">
			...
			<div className="flex flex-wrap gap-3 sm:flex-nowrap">
				<div className="me-auto space-y-3">
					...
					<div className="text-foreground/40">
						Miembro desde el {dateFormat(user.createdAt.toISOString())}
					</div>
			...
			{user.bio && (
				<div>
					<hr />
					<Linkify>
						<div className="mt-2 overflow-hidden whitespace-pre-line break-words">
							{user.bio}
						</div>
					</Linkify>
				</div>
