      ...
      <div className="flex min-h-screen flex-col">
        ...
        <div className="mx-auto flex w-full max-w-[1500px] grow gap-5 p-2 md:p-5">
          <div className="sticky top-[8.25rem] flex flex-col gap-5">
            ...
            <Suspense fallback={<Loader2 className="mx-auto animate-spin" />}><PopularMovies className="hidden h-fit flex-none space-y-3 rounded-2xl bg-card px-3 py-5 shadow-sm sm:block lg:px-5 xl:w-80 z-50" />
            </Suspense>
          </div>
          {children}
        </div>
